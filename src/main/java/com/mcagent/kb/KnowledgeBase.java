...
/**
 * 内置中文知识库:加载 assets/mcagent/kb/ 下 3 个 MD 文件,按 "## 小节" 分节并检索。
 *
...
public final class KnowledgeBase {
    ...
    private static final String[][] KB_FILES = {
            {"/assets/mcagent/kb/commands.md", "指令速查"},
            {"/assets/mcagent/kb/selectors.md", "选择器与坐标"},
            {"/assets/mcagent/kb/items_basics.md", "物品与组件"},
    };
    ...
    /** "/assets/mcagent/kb/commands.md" → "commands"。 */
