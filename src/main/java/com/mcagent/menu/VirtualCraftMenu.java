 ...
 * {@code mcagent_workbench_slot0} .. {@code mcagent_workbench_slot8}
...
public class VirtualCraftMenu extends CraftingMenu {
    ...
    /** 持久网格的存档键(mcagent_workbench_slot0 .. mcagent_workbench_slot8)。 */
    public static final String NBT_ROOT = "mcagent_workbench";
