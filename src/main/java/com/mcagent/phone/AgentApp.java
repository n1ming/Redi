...
public final class AgentApp implements IPhoneApp {
    private final ResourceLocation id = ResourceLocation.fromNamespaceAndPath(McAgentMod.MODID, "agent");
    private final ResourceLocation icon = ResourceLocation.fromNamespaceAndPath(McAgentMod.MODID, "textures/gui/agent_icon.png");
    ...
    public Component getDisplayName() {
        return Component.translatable("mcagent.app.agent");
    }
    ...
    @Override
    public void onPress() {
        com.mcagent.McAgentMod.LOGGER.info("[mcagent] onPress → 打开平铺界面");
    ...
    public String getDescription() {
        return Component.translatable("mcagent.app.agent.desc").getString();
    }
